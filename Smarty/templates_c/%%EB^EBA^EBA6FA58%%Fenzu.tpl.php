<?php /* Smarty version 2.6.18, created on 2012-12-21 15:08:56
         compiled from Fenzu.tpl */ ?>
<!--*********************************************************************************
...
">
<input type="hidden" name="record" value="<?php echo $this->_tpl_vars['FenzuID']; ?>
">
...
"><?php echo $this->_tpl_vars['APP'][$this->_tpl_vars['CURRENTMODULE']]; ?>
</a> &gt; <?php if ($this->_tpl_vars['CUSTOMVIEWID'] == ''): ?><?php echo $this->_tpl_vars['MOD']['New_Custom_View']; ?>
<?php else: ?>编辑分组<?php endif; ?></span> <br>
...
<tr>
		 <td class="detailedViewHeader"><strong><?php echo $this->_tpl_vars['MOD']['Details']; ?>
</strong></td>
		</tr>
		<tr>
		<td>
