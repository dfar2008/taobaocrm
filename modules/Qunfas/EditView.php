...
if((!isset($is_disable_approve) || (isset($is_disable_approve) && !$is_disable_approve)) && (isset($module_enable_approve) && $module_enable_approve)) {	$sql = "select approved from ec_qunfas where deleted=0 and qunfasid='".$_REQUEST['record']."'";
...
/*
if(empty($focus->column_fields['qunfaname'])) {
	$focus->column_fields['qunfaname'] = "GD".date("Ymd")."-".$focus->get_next_id();
}
