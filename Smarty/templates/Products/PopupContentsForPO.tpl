...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="small">
	<tr>
	{if $SELECT eq 'enable'}
		<td style="padding-left:10px;" align="left"><input class="crmbutton small save" type="button" value="{$APP.LBL_ADD_ITEM} {$APP[$MODULE]}" onclick="javascript:addMultiProductRow('PurchaseOrder');"/></td>
	{else}		
		<td>&nbsp;</td>	
	{/if}
	</tr>
   	<tr>
		...
		<input name="action" type="hidden" value="PopupForPO">
