...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="small">
	<tr>
	{if $SELECT eq 'enable'}
		<td style="padding-left:10px;" align="left"><input class="crmbutton small save" type="button" value="{$APP.LBL_ADD_ITEM} {$APP[$MODULE]}" onclick="javascript:addMultiProductRow('{$MODULES}');"/></td>
	{else}
		<td>&nbsp;</td>
	{/if}
	</tr>
   	<tr>
	    <td style="padding:5px;">
       		<input name="module" type="hidden" value="Products">
                <input name="modules" type="hidden" value="{$MODULES}">
		<input name="action" type="hidden" value="PopupForModules">
