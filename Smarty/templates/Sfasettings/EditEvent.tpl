								...
								<table border=0 cellspacing=0 cellpadding=0 width=100% class="small">
								   ...
								   <tr>
									<td  colspan=6 style="padding:5px">
									   <div align="center">
										<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" onclick="checkForm();" type="button" name="savebutton" value="  {$APP.LBL_SAVE_BUTTON_LABEL}  " style="width:70px" >
                                  ...
                                  <tr>
                                   <td class="dvtCellLabel" align="right"  colspan="3">
                                    ...
                                    <input id="sj"   type="text" name="sj" value="{$datarows.sj}"  style="width:200px;" >
                                 ...
                                 <tr>
                                   ...
                                   <input type="radio" {$arr_tt[0]} name="tt" value="0"/>
                                   <font color="#CC6699">【无 日 期】</font>不限定日期<br/>
                                  <input type="radio" name="tt" value="1" {$arr_tt[1]}/>
                                  <font color="#CC6699">【绝对日期】</font>开始日期
                                   <font color="#CC6699">                
                                  <input type="text" size="12"  value="{$datarows.tp11}" id="jscal_field_tp11" name="tp11" readonly="readonly"/>  
                                  ...
                                  <input type="text" size="12" value="{$datarows.tp21}" id="jscal_field_tp21" name="tp21" readonly="readonly"/>
                                  ...
                                  <input type="radio" name="tt" value="2" {$arr_tt[2]}/>
                                  <font color="#CC6699">【相对日期】</font>于基准日期             
                                  <font color="#CC6699"><input value="{$datarows.tp12}" size="2" name="tp12"/> </font>天后开始，持续             
                                  <input value="{$datarows.tp22}" size="2" name="tp22"/>   天结束 
                                  <br/>
                                  <input type="radio" name="tt" value="3" {$arr_tt[3]}/>
                                  <font color="#CC6699">【循　　环】</font>于基准日期             
                                  <input value="{$datarows.tp33}" size="2" name="tp33"/>  天后，每 
                                  <input value="{$datarows.tp13}" size="2" name="tp13"/>             
                                  天开始1次，持续 <input value="{$datarows.tp43}" size="2" name="tp43"/>          
                                  天结束；循环             
                                  <input value="{$datarows.tp23}" size="2" name="tp23"/>次<br/><font color="#808080">
                                 ...
                                 <tr>
                                   <td class="dvtCellLabel" align="right"  colspan="3" rowspan="3">
                                    ...
                                    <input type="radio" name="at" value="manual" {$arr_at.manual} />
                                   ...
                                   <td class="dvtCellInfo" align="left"  colspan="2" >
                                    ...
                                    <textarea cols="60" name="autoact_manual_sm" rows="5" style="width:60%">{$datarows.autoact_manual_sm}</textarea>
                                   </td>
                                   </tr>
                                    <tr>
                                    <td class="dvtCellInfo" align="left" width="10%" >
                                    <input type="radio" name="at" value="sms" {$arr_at.sms} />
                                    <font color="#3366FF"><b>发短信</b></font>
                                    </td>
                                   <td class="dvtCellInfo" align="left"  colspan="2" >
                                    <input type="radio" name="actauto_sms" value="1" {$arr_actauto_sms[1]} />自动  
                                    <input type="radio" value="0" name="actauto_sms" {$arr_actauto_sms[0]}/>手动<br/>
                                     ...
                                     <textarea cols="60" name="autoact_sms_sm" rows="5" style="width:60%"/>{$datarows.autoact_sms_sm}</textarea><br/>　　　　　
                                     <span style="background-color: rgb(102, 170, 255); color: rgb(255, 255, 255);"> 通配符:会员名称$membername$; </span>
                                    
                                   <tr>
                                    <td class="dvtCellInfo" align="left" width="10%" >
                                    <input type="radio" name="at" value="email" {$arr_at.email}/>
                                    <font color="#3366FF"><b>发邮件</b></font>
                                    </td>
                                   <td class="dvtCellInfo" align="left"  colspan="2" >
                                    <input type="radio" name="actauto_email" value="1"  {$arr_actauto_email[1]} />自动  
                                    <input type="radio"  value="0" name="actauto_email"  {$arr_actauto_email[0]} />手动<br/>
                                    <font color="808080">抄　　送：</font>
                                    <input type="checkbox" value="{$autoact_email_cc_val}" name="autoact_email_cc" {$arr_autoact_email_cc}/>抄送自己<br/>
                                    <font color="808080">发 件 人：</font>
                                    <input type="radio" name="autoact_email_rt" value="0" {$arr_autoact_email_rt.0}/>
                                    企业统一邮件地址    
                                    <input type="radio" name="autoact_email_rt" value="1" {$arr_autoact_email_rt.1}/>
                                    执行人邮件地址<br/>
                                    <font color="808080">邮件标题：</font>
                                    <input type="edit" value="{$datarows.autoact_email_bt}" size="50" name="autoact_email_bt"/><br/>　　　　
                                  ...
                                  <textarea cols="60" name="autoact_email_sm" rows="5" style="width:60%"/>{$datarows.autoact_email_sm}</textarea>
...
function checkForm(){
	...
	new Ajax.Request(
			...
			method: 'post',
			postBody:"module=Sfasettings&action=SfasettingsAjax&file=SaveEvent&ajax=true&sj="+sj+"&sfasettingsid="+sfasettingsid+"&record="+record,
