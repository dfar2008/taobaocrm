<?php /* Smarty version 2.6.18, created on 2012-12-21 11:19:07
         compiled from OnlineAccsalesreports/ListView.tpl */ ?>
...
><?php echo $this->_tpl_vars['val']; ?>
			...
			<td nowrap="nowrap">
            	统计类型：
				<select name="reporttyp" id="reporttyp">
                    <?php $_from = $this->_tpl_vars['REPORTTYPEARR']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['key'] => $this->_tpl_vars['val']):
?>
                    	<?php if ($this->_tpl_vars['key'] == $this->_tpl_vars['reporttyp']): ?>
...
<?php if ($this->_tpl_vars['LISTENTRYHTML'] && $this->_tpl_vars['LISTENTRYHTML'] != ''): ?>
    <tr style="height: 25px; display:none;" class='report_part'> 
        ...
        <td class="lvtCol" nowrap align='center'>统计结果</td>
    </tr>
    </tr>
