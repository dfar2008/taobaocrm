...
<div id="createaccount_div" style="display:block;position:absolute;left:225px;top:150px;"></div>
<div id="status" style="position:absolute;display:none;left:100px;top:95px;height:27px;white-space:nowrap;"><img src="{$THEME_PATH}images/status.gif"></div>
					...
					<td style="padding:10px;" >
						...
						<tr>
							...
							{if $CREATE_PERMISSION eq "permitted"}
								&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="button" name="create" value=" &nbsp;{$APP.LNK_NEW_ACCOUNT}&nbsp; " onClick="callCreateAccountDiv();" class="crmbutton small create">
							{/if}
							</td>
						</tr>
						 <tr>
