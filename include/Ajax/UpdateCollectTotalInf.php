...
?>
●<a style="color: rgb(153, 102, 51);" href="javascript:openListViewReport('index.php?module=ListViewReport&action=Popup_ListView&grouptype=count&<?php echo $reportparams;?>','<?php echo $urlstr1;?>');">负责人分布统计</a>
<?php
}
