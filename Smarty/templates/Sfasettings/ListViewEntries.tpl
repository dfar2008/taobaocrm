...
<form name="massdelete" method="POST" action="index.php">
     ...
     <input name="allids" type="hidden" value="{$ALLIDS}">
			...
			<input class="crmbutton small create" type="button" value="新增方案" name="Create" onclick="javascript:location.href='index.php?module=Sfasettings&action=EditView'" accesskey="新增方案" title="新增方案">
                </td>
				<!-- Page Navigation -->
