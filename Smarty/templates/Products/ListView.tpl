      ...
      <tbody>
        <tr>
              <td style="padding-left:5px;">
                 <input title="{$APP.LNK_NEW_PRODUCT}" accessKey="{$APP.LNK_NEW_PRODUCT}" class="crmbutton small create" onclick="javascript:location.href='index.php?module=Products&action=EditView'" type="button" name="Create" value="{$APP.LNK_NEW_PRODUCT}">&nbsp;
               </td> 
...
{*<!-- Searching UI -->*}
	  ...
	  <div id="ListViewContents">
			{include file="Products/ListViewEntries.tpl"}
	  </div>
	  </td>
	  </tr>
	  </table>
