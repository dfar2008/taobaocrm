...
$query .= "where ec_salesorder.deleted = 0  and ec_salesorder.smownerid=".$current_user->id." ";
...
if(count($months_count) > 0) {
	$resflash = '';
	$title = "会员购买时间分布 ({$titlearr[$reporttyp]}/小时)";
...
$smarty->display("OnlineAccsalesreports/ListView.tpl");
