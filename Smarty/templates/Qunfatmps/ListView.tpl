      ...
      <tbody>
        <tr>
              <td style="padding-left:5px;">
                 <input title="{$APP.LNK_NEW_QUNFATMP}" accessKey="{$APP.LNK_NEW_QUNFATMP}" class="crmbutton small create" onclick="javascript:location.href='index.php?module=Qunfatmps&action=EditView'" type="button" name="Create" value="{$APP.LNK_NEW_QUNFATMP}">&nbsp;
               </td> 
...
{*<!-- Searching UI -->*}
	  ...
	  <div id="ListViewContents">
			{include file="Qunfatmps/ListViewEntries.tpl"}
	  </div>
	  </td>
	  </tr>
	  </table>
