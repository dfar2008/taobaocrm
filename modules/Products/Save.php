...
if(isset($_REQUEST['dup_check']) && $_REQUEST['dup_check'] != '')
{
		...
		if(empty($record)) {
			$query = "SELECT productcode FROM ec_products WHERE deleted=0 and productcode ='".$productcode."'";
		} else {
			$query = "SELECT productcode FROM ec_products WHERE deleted=0 and productid !=".$record." and productcode ='".$productcode."'";
		}
