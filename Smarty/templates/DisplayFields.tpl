	...
	{foreach key=mainlabel item=maindata from=$subdata}
		...
		{elseif $uitype eq 19 || $uitype eq 20}
            ...
            {if $MODULE eq 'Maillisttmps' || $MODULE eq 'Qunfatmps'}
				<textarea{$disable} class="detailedViewTextBox" tabindex="{$vt_tab}" onFocus="this.className='detailedViewTextBoxOn'" name="{$fldname}"  onBlur="this.className='detailedViewTextBox'" cols="90" style="height:200px;" >{$fldvalue|escape}</textarea>
                {else}
