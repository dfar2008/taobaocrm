...
class ADODB_mysql extends ADOConnection {
	...
	function _connect($argHostname, $argUsername, $argPassword, $argDatabasename)
	{
		...
		mysql_query("SET character_set_connection=utf8,character_set_results=utf8,character_set_client=binary,sql_mode=''", $this->_connectionID);
	...
	function _pconnect($argHostname, $argUsername, $argPassword, $argDatabasename)
	{
		...
		if ($this->_connectionID === false) return false;
		//changed by dingjianting on 2006-10-29 for support utf8
		mysql_query("SET CHARACTER SET 'utf8'",$this->_connectionID);
		mysql_query("SET NAMES 'utf8'",$this->_connectionID);
		mysql_query("SET character_set_connection=utf8,character_set_results=utf8,character_set_client=binary,sql_mode=''", $this->_connectionID);
		if ($this->autoRollback) $this->RollbackTrans();
		if ($argDatabasename) {
			$isSelectDB = $this->SelectDB($argDatabasename);
		} else {
			$isSelectDB = false;
		}
		$endTime1 = microtime();
