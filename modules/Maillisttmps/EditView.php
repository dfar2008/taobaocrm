...
else $return_module = "Maillisttmps";
...
if((!isset($is_disable_approve) || (isset($is_disable_approve) && !$is_disable_approve)) && (isset($module_enable_approve) && $module_enable_approve)) {	$sql = "select approved from ec_maillisttmps where deleted=0 and maillisttmpsid='".$_REQUEST['record']."'";
