								...
								<div class="MatrixLayer" style="float:left;width:61%;" id="homepagedb">
									<table width="100%" border="0" cellpadding="8" cellspacing="0" class="small">
										<tr style="cursor:move;">
											<td align="left" class="homePageMatrixHdr"><b>{$APP.LBL_SALES_BY_MONTH}</b></td>
											<td align="right" class="homePageMatrixHdr"><img src="{$IMAGE_PATH}uparrow.gif" align="absmiddle" /></td>
										</tr>
										<tr>	
										<td colspan="2">
										<div style="overflow:hidden;height:243px;width:99%"> 
											<table border=0 cellspacing=0 cellpadding=5 width=100%>
												<tr><td id="dashborad_cont">{php}include("modules/Dashboard/Sales_By_Month.php");{/php}</td></tr>
											</table>
										</div>
										<table border=0 cellspacing=0 cellpadding=5 width=100%>
												<tr>
