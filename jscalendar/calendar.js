...
// Fixed double display of a day when daylight saving time starts by Elmue Oct. 2008
// Fixed display of wrong week number if week starts with sunday  by Elmue Oct. 2008
// Added support for defining first day of week in config.inc.php by Elmue Oct. 2008

// $Id: calendar.js 11471 2007-10-15 12:18:52Z mangai $

/** The Calendar object constructor. */
Calendar = function (dummy, dateStr, onSelected, onClose) {
	// member variables
	this.activeDiv = null;
	...
	this.firstDayOfWeek = javaCalendarFirstDayOfWeek; // defined in index.php + header.tpl
...
Calendar.prototype.showAtElement = function (el, opts) {
	...
	function fixPosition(box) {
		...
		//added by dingjianting on 2008-08-12 for IE7
		if (Calendar.is_ie7) {
			br.y += window.scrollY;
			br.x += window.scrollX;
		} 
...
/** Returns the number of the week in year, as defined in ISO 8601. (see Wikipedia) */
