...
<tr>
<td colspan=9>
<div id="yincangdiao" style="display:none; visibility:hidden;"> 
...
{assign var="FINAL" value=$ASSOCIATEDPRODUCTS.1.final_details}
   ...
   <tr valign="top">
	...
	<td class="crmTableRow small" align="right">
		<input id="shipping_handling_charge" name="shipping_handling_charge" type="text" class="small" style="width:40px" align="right" value="{$FINAL.shipping_handling_charge}" onBlur="calcTotal();">%
	</td>
   </tr>
...
<table width="100%"  border="0" align="right" cellpadding="5" cellspacing="0" class="crmTable">
   <tr valign="top">
	<td class="crmTableRow big lineOnTop" style="border-right:1px #dadada;" width="30%">&nbsp;</td>
	<td class="crmTableRow big lineOnTop" align="right" width="50%"><b>{$APP.LBL_GRAND_TOTAL}</b></td>
	<td id="grandTotal" name="grandTotal" class="crmTableRow big lineOnTop" align="right" width="20%">{$FINAL.grandTotal}</td>
   </tr>
</table>
