 ...
 ********************************************************************************/
/*********************************************************************************
 * $Header: /advent/projects/wesat/ec_crm/sugarcrm/include/utils/EditViewUtils.php,v 1.188 2005/04/29 05:5 * 4:39 rank Exp  
...
require_once($root_directory.'include/utils/MultiFieldUtils.php');
...
function getOutputHtml($uitype, $fieldname, $fieldlabel, $maxlength, $col_fields,$generatedtype,$module_name,$mode='',$mandatory=0,$typeofdata="")
{
	...
	{	
		...
		if($value=='')
		{
			...
			//changed by dingjianting on 2008-11-13 for permitting blank date
