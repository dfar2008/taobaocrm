					...
					<td style="padding:10px;" >
						...
						<tr>
							...
							<td width="30%" class="dvtCellLabel">
								...
								<input type="hidden" name="action" value="PopupForInventory">
...
{ldelim}
	...
	urlstring = urlstring +'&query=true&file=PopupForInventory&module=Products&action=ProductsAjax&ajax=true';
...
{ldelim}
    ...
    var urlstring ="module="+module+"&action="+module+"Ajax&file=PopupForInventory&ajax=true&"+url;
    urlstring +=gethiddenelements();
    new Ajax.Request(
                'index.php',
                {ldelim}queue: {ldelim}position: 'end', scope: 'command'{rdelim},
