	...
	<tr>
		<td class=small >
			<table border=0 celspacing=0 cellpadding=5 width=100% align=center bgcolor=white>
				...
				<tr>
					<td width="30%" align="right" class="dvtCellLabel">'.$mod_strings['Num'].'</td>
					<td width="70%" align="left" class="dvtCellInfo">
					<input class="detailedViewTextBox"  onfocus="this.className=\'detailedViewTextBoxOn\'" name="num" id="num" onblur="this.className=\'detailedViewTextBox\'" value="">
                    </td>
			    </tr>
