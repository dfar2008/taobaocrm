...
<form name="massdelete" method="POST" action="index.php">
     ...
     <input name="module" id="module" type="hidden" value="Sfalogs">
				...
				选择日期: &nbsp;  &nbsp;<input type="text" size="15"  name="searchdate" id="jscal_field_searchdate"  value="{$searchdate}" />
              <img id="jscal_trigger_searchdate" src="themes/softed/images/calendar.gif">
                <script type="text/javascript">
                Calendar.setup ({ldelim}
                inputField : "jscal_field_searchdate", ifFormat : "%Y-%m-%d", showsTime : false, button : "jscal_trigger_searchdate", singleClick : true, step : 1
                {rdelim})
                </script> 
                &nbsp; &nbsp; &nbsp; &nbsp;
                <input type="submit" name="submit" value="      搜索     "  class="crmbutton small create" />
                </td>
				<!-- Page Navigation -->
