...
<tr>
	...
	<tr>
		...
		<td width="50%" class="cellText small"><input class="dataInput" type="text" id="list_price" name="list_price" value="'.$listprice.'" onkeydown="if(event.keyCode==13) {gotoUpdateListPrice('.$return_id.','.$pricebook_id.','.$product_id.');return false;}"/></td>
	</tr>
	</table>
	</td>
</tr>
...
<tr>
	...
	<input type="button" onclick="gotoUpdateListPrice('.$return_id.','.$pricebook_id.','.$product_id.');" name="button" value="'.$app_strings["LBL_SAVE_BUTTON_LABEL"].'"  class="crmbutton small save">
