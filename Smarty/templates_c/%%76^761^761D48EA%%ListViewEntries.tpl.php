                          ...
                          <tr>
                            ...
                            <td  valign="top" bgcolor="#EFEFEF" align="center" width="25%">
                              <table cellspacing="0" cellpadding="3" border="0">
                                ...
                                <td valign="top">
                                <p align="center">
                                <textarea style="line-height: 150%;width: 300px; height: 510px;" cols="35" name="dst" rows="8" id="receiveaccountinfo" readonly="readonly"></textarea>
                                </p>
                                </td>
                                </tr>
                                </tbody>
...
" type="hidden">
                               ...
                               <br />
                                <textarea rows="15"  name="mailcontent" id="mailcontent" style="height:380px;" readonly="readonly"></textarea>
                                </p>
                                </td>
                                </tr>
                                <tr>
...
" name="sjid" id="sjid" />
                                ...
                                <td  style="text-align:center; vertical-align:bottom;padding-top:50px;">
                                 <input type="button" name="savebutton" value="&nbsp;&nbsp;&nbsp;&nbsp;群发&nbsp;&nbsp;&nbsp;&nbsp; "   class="crmbutton small edit" onclick="SendMailToAll('Maillists','<?php echo $this->_tpl_vars['sjid']; ?>
');return false;" />
                                </td>
                                </tr>
                                </tbody>
