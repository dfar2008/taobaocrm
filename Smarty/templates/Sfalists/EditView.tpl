							...
							<!-- General details -->
								...
								<table border=0 cellspacing=0 cellpadding=0 width=100% class="small">
									 ...
									 <tr>
                                        ...
                                        <td class="dvtCellInfo" align="left" width="30%">
                                        <input id="sfalistname"  type="text"  value="{$sfalistname}" size="25" style="color:#999" tabindex="1" name="sfalistname">*(为空时,自动生成序列编号)
                                        </td>
                                    </tr>
                                   	 <tr>
                                         <td class="dvtCellLabel" align="right" width="20%">
                                        ...
                                        <td class="dvtCellInfo" align="left" width="30%">
                                      <input type="text" size="12"  value="{$fsdate}" id="fsdate" name="fsdate" readonly="readonly"/>  
...
function checkChongfu(){
	...
	new Ajax.Request(
			...
			result = response.responseText; alert(result);
					if(result == 'FAILED') {
						alert("标题重复");
						return false;	
