...
<script language="JavaScript" type="text/javascript" src="modules/{$MODULES}/{$MODULES}.js"></script>
					...
					<td style="padding:10px;" >
						...
						<tr>
							...
							<td width="30%" class="dvtCellLabel">
								...
								<input type="hidden" name="action" value="PopupForModules">
			...
			<table border="0" cellpadding="0" cellspacing="0" style="padding-right:5px;padding-top:2px;padding-bottom:2px;">
			  ...
			  {/foreach}
		       ...
		       <tr><td valign="top" width="15%">
		               {include file="Products/CatalogPopupForModules.tpl"}
		       </td>
		       <td width=70% align="left" valign=top style="border-left:2px dashed #cccccc;padding:13px">
			<div id="ListViewContents">
				{include file="Products/PopupContentForModules.tpl"}
			</div>
			</td>
			</tr>
			</table>
...
{ldelim}
	...
	urlstring = urlstring +'&query=true&file=PopupForModules&modules={$MODULES}&module=Products&action=ProductsAjax&ajax=true';
...
{ldelim}
    ...
    var urlstring ="module="+module+"&action="+module+"Ajax&file=PopupForModules&modules={$MODULES}&ajax=true&"+url;
    urlstring +=gethiddenelements();
    new Ajax.Request(
                'index.php',
                {ldelim}queue: {ldelim}position: 'end', scope: 'command'{rdelim},
...
{ldelim}
        var urlstring ="module="+module+"&action="+module+"Ajax&file=PopupForModules&ajax=true&modules={$MODULES}"+url;
	new Ajax.Request(
                'index.php',
                {ldelim}queue: {ldelim}position: 'end', scope: 'command'{rdelim},
                                method: 'post',
