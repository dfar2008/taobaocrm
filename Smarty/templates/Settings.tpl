			...
			<tr>
				...
				<tr>
                    ...
                    <td width=12.5% valign=top>
						<table border=0 cellspacing=0 cellpadding=5 width=100%>
						<tr>
							<td  valign=top><a href="index.php?module=Settings&action=RelatedList&parenttab=Settings"><img src="{$IMAGE_PATH}relatedinfo.gif" width="48" height="48" border=0></a></td>
						</tr>
						<tr>
							<td class=big valign=top><a href="index.php?module=Settings&action=RelatedList&parenttab=Settings">{$MOD.LBL_RELATED_LIST}</a></td>
						</tr>
