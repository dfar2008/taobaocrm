...
if((!isset($is_disable_approve) || (isset($is_disable_approve) && !$is_disable_approve)) && (isset($module_enable_approve) && $module_enable_approve)) {	$sql = "select approved from ec_qunfatmps where deleted=0 and qunfatmpsid='".$_REQUEST['record']."'";
...
/*
if(empty($focus->column_fields['qunfatmpname'])) {
	$focus->column_fields['qunfatmpname'] = "GD".date("Ymd")."-".$focus->get_next_id();
}
