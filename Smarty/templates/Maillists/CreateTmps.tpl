...
<td style="padding-left:10px;"><b>新增 邮件模板</b></td>
</tr>
...
<table border=0 cellspacing=0 cellpadding=0 width=100% align=left class="small">
   <tr height="25">
   		...
   		<td width="90%"><input id="maillisttmpname" class="detailedViewTextBox" type="text" onBlur="this.className='detailedViewTextBox'" onFocus="this.className='detailedViewTextBoxOn'" value="" tabindex="1" name="maillisttmpname"></td>
   </tr>
   <tr>
   ...
   <tr>
    <td width="15%">&nbsp;</td><td width="18%">备注: 可用变量<b> $membername$ </b>替换群发中的<b>客户名称</b>.</td>									
   </tr>
   <tr>
